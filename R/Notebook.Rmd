...
no_survivorsexpanded_noapril <- no_survivorsexpanded_noapril %>% 
  pivot_wider(names_from = Month_survivor, values_from = status) #Pivot this data wider so that I can do a join
